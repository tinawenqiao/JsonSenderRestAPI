package org.cmbc.bigdata.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity handleExceptionInternal(Exception ex, Object body,
    ...
    log.info("Enter the GlobalExceptionHandler.handleExceptionInternal Method.");
    return buildResponseEntity(new RestResult(HttpStatus.INTERNAL_SERVER_ERROR, error ,ex));
  }
  ...
  protected ResponseEntity handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
    ...
    return buildResponseEntity(new RestResult(HttpStatus.METHOD_NOT_ALLOWED, builder.substring(0, builder.length() - 2), ex));
  }
  ...
  protected ResponseEntity handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
    ...
    return buildResponseEntity(new RestResult(HttpStatus.UNSUPPORTED_MEDIA_TYPE,
  ...
  protected ResponseEntity handleHttpMediaTypeNotAcceptable(HttpMediaTypeNotAcceptableException ex,
    ...
    return buildResponseEntity(new RestResult(HttpStatus.NOT_ACCEPTABLE, error ,ex));
  }
  ...
  protected ResponseEntity<Object> handleMissingPathVariable(MissingPathVariableException ex,
    ...
    return buildResponseEntity(new RestResult(HttpStatus.BAD_REQUEST, error, ex));
  }
  ...
  protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
    ...
    log.info("Caught MissingServletRequestParameter Exception.");
    return buildResponseEntity(new RestResult(HttpStatus.BAD_REQUEST, error, ex));
  }
  ...
  protected ResponseEntity handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
    ...
    RestResult restErrorResponse = new RestResult(HttpStatus.BAD_REQUEST, error, ex);
  ...
  protected ResponseEntity handleNoHandlerFoundException(
    ...
    return buildResponseEntity(new RestResult(HttpStatus.NOT_FOUND, error, ex));
  }
